...
from lander import CartPoleEnv
...
action_space = spaces.Discrete(2)  # Choose among [0, 1]
env = CartPoleEnv()
...
def play_random_games(games=100):
    ...
    dataframe = pd.DataFrame(
        all_movements,
        columns=['cart_position', 'cart_velocity', 'pole_angle', 'pole_velocity_at_tip', 'action_to_left',
                 'action_to_right']
    )
