...
def chain_pulling(amino, use_greedy, optimalization_tries, chain_generations, pull_times_per_chain, ThreeD):
    best_stability = 0
    best_chain_list = []
    ...
    for i in range(0, chain_generations):
        ...
        Chain = generate_chain(amino, use_greedy, optimalization_tries, ThreeD)
