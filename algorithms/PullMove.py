...
# Returns coords of i, i+1 and the vector between these coords
...
# if multiple L and C's are free, returns a random choice of them.
def check_requirements(grid_object, available_moves, vector1, node_i_coords, node_i1_coords):
    viable_moves = []
    found = False
